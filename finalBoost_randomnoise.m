...
Features=[Features;randn(20,size(Features,2))];

params={T,errles};
[Idxdecision,totalcorrect,percentperclasscorrect,confusionmatrix,vtrain]=BoostOneVersusRest(Features,[labels,labelstest],trainnumsuse,testnums,params);

%save finalboost_train_am_test_an_randomnoise
save finalboost_train_an_test_am_randomnoise