...
function [assignedLabels,totalCorrect,percentClassCorrect,confusionMat,pointData,partitionSet,learnedParameters] = ...
    doCrossValidationFixedParams_corruptednoise(dataFile, fAlgorithm, algoParams, numPartitions, noisyFeaturesFactor)

pointData = PointCloudData(dataFile,1);
pointData = pointData.addCorruptedNoisyFeatures(noisyFeaturesFactor);
