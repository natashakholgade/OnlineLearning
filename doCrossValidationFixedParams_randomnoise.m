...
function [assignedLabels,totalCorrect,percentClassCorrect,confusionMat,pointData,partitionSet,learnedParameters] = ...
    doCrossValidationFixedParams_randomnoise(dataFile, fAlgorithm, algoParams, numPartitions, numNoisyFeat)

pointData = PointCloudData(dataFile,1);
pointData = pointData.addRandomNoisyFeatures(numNoisyFeat);
