...
function [assignedLabels,totalCorrect,percentClassCorrect,confusionMat,pointData,partitionSet,learnedParameters] = ...
    doCrossValidationFixedParamsSameProportion(dataFile, fAlgorithm, algoParams, numPartitions)

pointData = PointCloudData(dataFile,1);
[partitionSet,n] = DataPartition.RandomDataPartitionSet(pointData, numPartitions, 1);
